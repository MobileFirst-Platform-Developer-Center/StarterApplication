...
function wlEnvInit(){
    wlCommonInit();
    // Win8 Environment initialization: options menu
    WL.OptionsMenu.init();
    WL.OptionsMenu.addItem("feedsTab", displayFeedsTab, Messages.navToFeeds, {image: 'feed.png'});
    WL.OptionsMenu.addItem("aboutTab", displayAboutTab, Messages.navToAbout, {image: 'about.png'});
    // Win8 Environment initialization: layout
...
function setListHeight(){
	var deviceHeight = $(window).height() - 60;
	$('#feed').css('height', deviceHeight);
	$('#feedItemContent').css('min-height', deviceHeight);
}
